    ...
    return (
      <div style={{width: '100%', maxWidth: 700, margin: 'auto'}}>
        <Stepper activeStep={stepIndex}>
          <Step>
            <StepLabel><Icon name="person" /></StepLabel>
          </Step>
          <Step>
            <StepLabel><Icon name="history" /></StepLabel>
          </Step>
          <Step>
            <StepLabel><Icon name="layers" /></StepLabel>
          </Step>
		  <Step>
            <StepLabel><Icon name="wc" /></StepLabel>
          </Step>
		  <Step>
            <StepLabel><Icon name="home" /></StepLabel>
          </Step>
		  <Step>
            <StepLabel><Icon name="person_pin_circle" /></StepLabel>
          </Step>
        </Stepper>
